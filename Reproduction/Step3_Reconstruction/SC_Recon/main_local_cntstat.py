...
def parse_args():
    ...
    parser.add_argument("--data-file-name", type=str, default="ContrastPhantom_8_28_240_30", help="Phantom or dataset name.")
    parser.add_argument("--count-level", type=str, default="1e13", help="Count level suffix in CntStat filename.")
    ...
    parser.add_argument("--osem-subset-num", type=int, default=16, help="Number of OSEM subsets.")
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "For example, 'SPECTEHENaI' selects "
