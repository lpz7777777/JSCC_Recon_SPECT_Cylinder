...
class EventAction : public G4UserEventAction
{
  public:
    ...
    void ChangeScinCopyNum(int CopyNum){Scin_CopyNum = CopyNum;};
    void ChangePos1(G4ThreeVector Pos){Position1 = Pos;};
    void ChangePos2(G4ThreeVector Pos){Position2 = Pos;};
    void AddEnergy(int number,G4double energy1){TempEnergy[number] += energy1;};
    void AddEnergyReal(int number,G4double energy1){TempEnergy_Real[number] += energy1;};
    void AddSingleScinEnergy(G4double Energy){SingleScinEnergy+=Energy;};
    void AddNumPhot(){NumPhot++;};
    void AddNumCompt(){NumCompt++;};
    void ClearSingleScinEnergy(){SingleScinEnergy=0;};
    ...
    int GetFlagCompt(){return Flag_Compt;};
    int GetScinCopyNum(){return Scin_CopyNum;};
  ...
  private:
    ...
    G4double* TempEnergy_CrystalTotal_Real;
    G4double* TempEnergyPos_CrystalTotal;
    G4double Threshold;
    G4double SingleScinEnergy;
    ...
    PrimaryEnergyClass fPrimaryEnergyClass;
};
