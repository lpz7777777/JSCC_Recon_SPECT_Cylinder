...
from distributed.python.recon_osem_dist import run_recon_osem_dist
...
def main():
    ...
    name_prefix = build_output_name_prefix(e0_list, rotate_num, data_file_name)
    save_path = f"./Figure_Dist/{name_prefix}_{count_level}_{ds}_SMap{s_map_d_ratio}_Delta{delta_r1}_Alpha{alpha}_ER{ene_resolution_662keV}_OSEM{iter_arg.osem_subset_num}_ITER{iter_arg.jsccsd}_SDU{format_scientific_count(single_event_count_total)}_DDU{format_scientific_count(compton_event_count_total)}/Polar/"
