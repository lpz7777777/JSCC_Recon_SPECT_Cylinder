...
def parse_args():
    ...
    parser.add_argument("--sc-iter", type=int, default=10000, help="SC iteration count.")
    parser.add_argument("--jsccd-iter", type=int, default=5000, help="JSCC-D iteration count.")
    parser.add_argument("--jsccsd-iter", type=int, default=10000, help="JSCC-SD iteration count.")
    ...
    parser.add_argument("--output-root", type=str, default="./Results/Reconstruction/Figure_Dist", help="Output root directory.")
