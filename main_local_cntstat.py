...
def parse_args():
    ...
    parser.add_argument("--pixel-num-layer", type=int, default=2700, help="Number of polar pixels per slice.")
    ...
    parser.add_argument("--sc-iter", type=int, default=500, help="Number of SC OSEM iterations.")
    parser.add_argument("--save-iter-step", type=int, default=5, help="Save interval.")
    parser.add_argument("--osem-subset-num", type=int, default=1, help="Number of OSEM subsets.")
    parser.add_argument("--seed", type=int, default=20260519, help="Random seed.")
